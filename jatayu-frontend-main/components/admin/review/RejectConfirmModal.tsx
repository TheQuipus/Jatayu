      ...
      <div className={styles.modalCard} style={{ maxWidth: "480px" }}>
        <div className={styles.modalHeader}>
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            <div className={`${styles.confirmIconWrap} ${styles.confirmIconReject}`} style={{ width: "32px", height: "32px", background: "rgba(239, 68, 68, 0.12)", color: "#b91c1c" }}>
              <AlertCircle size={18} />
            </div>
        ...
        <div className={styles.modalActions}>
          ...
          <button
            type="button"
            className={`${styles.modalConfirmBtn} ${styles.modalBtnReject}`}
            disabled={!isValid}
            onClick={() => {
              if (hasIssues) {
