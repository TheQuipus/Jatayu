    ...
    <div className={styles.kpiRow}>
      <div className={styles.kpiCard}>
        <div className={styles.kpiHeader}>
          <span className={styles.kpiLabel}>Sessions Completed</span>
          <div className={styles.kpiIconBox}>
            <Video size={20} />
          </div>
        </div>
        <h3 className={styles.kpiValue}>{totalSessionsCount}</h3>
        <div className={styles.kpiSubDetail} style={{ color: "#16a34a", fontWeight: 600 }}>+3 this month</div>
      </div>

      <div className={styles.kpiCard}>
        <div className={styles.kpiHeader}>
          <span className={styles.kpiLabel}>{isExpert ? "Hours Taught" : "Hours Consulted"}</span>
          <div className={styles.kpiIconBox}>
            <Clock size={20} />
          </div>
        </div>
