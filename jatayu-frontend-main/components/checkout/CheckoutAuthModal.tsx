                ...
                <div className={styles.registerForm}>
                  <div className={styles.registerFieldGroup}>
                    ...
                    <div className={styles.registerInputFieldWrap}>
                      <div
                        className={`${styles.registerInputWrap} ${loginSubmitAttempted && !loginEmail.trim()
                  ...
                  <div className={styles.registerFieldGroup}>
                    ...
                    <div className={styles.registerInputFieldWrap}>
                      <div
                        className={`${styles.registerInputWrap} ${styles.registerInputWrapWithToggle} ${loginSubmitAttempted && !loginPassword.trim()
                            ? styles.registerInputWrapError
                            : ""
                          }`}
                      >
                      ...
                      <div className={styles.registerPasswordStrengthRow}>
                        ...
                        <div className={styles.registerPasswordStrengthLabels}>
                          {registerPasswordStrengthLabel ? (
                            ...
                            <span
                              className={`${styles.registerPasswordHint} ${registerFieldError("password")
