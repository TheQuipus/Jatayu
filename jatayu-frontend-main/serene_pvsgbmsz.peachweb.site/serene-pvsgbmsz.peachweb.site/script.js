(() => {
    ...
    var t, n, e, r, o, i = {
            ...
            3664: (t, n, e) => {
                ...
                const r = (t, n) => t.startsWith(n) ? t.substring(n.length) : t,
                    o = (t, n) => t.endsWith(n) ? t.substring(0, t.length - n.length) : t;
                ...
                function i(t) {
                    ...
                    return n.startsWith("/") || (n = `/${n}`), n.endsWith("/") || (n = `${n}/`), n
                }
                ...
                function s(t) {
                    ...
                    const n = (t = (t = o(t, "/")).substring(t.lastIndexOf("/") + 1)).lastIndexOf(".");
                    return n < 0 ? "" : t.substring(n + 1)
                }

                function u(t, n = ["-", "_", " ", ".", "[A-Z]"]) {
                    const e = n.map((t => "[A-Z]" === t ? "(?=[A-Z])" : t.replace(/[-/\\^$*+?.()|[\]{}]/g, "\\$&"))).join("|"),
                        r = new RegExp(e, "g");
                    return t.trim().split(r).map((t => t.toLowerCase()))
                }
            ...
            6096: (t, n, e) => {
                ...
                f.prototype.clear = r, f.prototype.delete = c, f.prototype.get = s, f.prototype.has = u, f.prototype.set = l;
                const p = f
            },
            5436: (t, n, e) => {
                e.d(n, {
            ...
            3269: (t, n, e) => {
                ...
                f.prototype.clear = o, f.prototype.delete = i, f.prototype.get = c, f.prototype.has = u, f.prototype.set = l;
                const p = f;
                var d = e(6096),
                    h = e(5436);
                const v = function() {
                ...
                m.prototype.clear = v, m.prototype.delete = _, m.prototype.get = g, m.prototype.has = A, m.prototype.set = w;
                const j = m
            },
            3516: (t, n, e) => {
                e.d(n, {
            ...
            5841: (t, n, e) => {
                ...
                var r = e(9333),
                    o = e(9322);
                const i = function(t, n) {
                    for (var e = 0, i = (n = (0, r.A)(n, t)).length; null != t && e < i;) t = t[(0, o.A)(n[e++])];
            ...
            4044: (t, n, e) => {
                ...
                const p = function(t) {
                    return null == t ? void 0 === t ? "[object Undefined]" : "[object Null]" : f && f in Object(t) ? s(t) : l(t)
                }
            },
            817: (t, n, e) => {
                e.d(n, {
            ...
            9333: (t, n, e) => {
                ...
                const l = function(t) {
                    ...
                    var n = [];
                    return 46 === t.charCodeAt(0) && n.push(""), t.replace(s, (function(t, e, r, o) {
            ...
            123: (t, n, e) => {
                ...
                const b = function(t) {
                    return !(!(0, s.A)(t) || c(t)) && ((0, r.A)(t) ? v : l).test((0, u.A)(t))
                };
                const y = function(t, n) {
            ...
            1677: (t, n, e) => {
                ...
                const c = function(t, n) {
                    if ((0, r.A)(t)) return !1;
                    var e = typeof t;
                    return !("number" != e && "symbol" != e && "boolean" != e && null != t && !(0, o.A)(t)) || (a.test(t) || !i.test(t) || null != n && t in Object(n))
                }
            },
            9600: (t, n, e) => {
                e.d(n, {
    ...
    c.m = i, c.n = t => {
            ...
            for (var e in n) c.o(n, e) && !c.o(t, e) && Object.defineProperty(t, e, {
                enumerable: !0,
                get: n[e]
            })
        }, c.f = {}, c.e = t => Promise.all(Object.keys(c.f).reduce(((n, e) => (c.f[e](t, n), n)), [])), c.u = t => t + ".script.js", c.g = function() {
        ...
        }(), c.o = (t, n) => Object.prototype.hasOwnProperty.call(t, n), t = {}, n = "pwb-website-base:", c.l = (e, r, o, i) => {
            if (t[e]) t[e].push(r);
            else {
                var a, s;
                if (void 0 !== o)
                ...
                a || (s = !0, (a = document.createElement("script")).charset = "utf-8", a.timeout = 120, c.nc && a.setAttribute("nonce", c.nc), a.setAttribute("data-webpack", n + o), a.src = e), t[e] = [r];
                var p = (n, r) => {
                        a.onerror = a.onload = null, clearTimeout(d);
                        var o = t[e];
                        if (delete t[e], a.parentNode && a.parentNode.removeChild(a), o && o.forEach((t => t(r))), n) return n(r)
                    },
            ...
            if (!t && n && (n.currentScript && (t = n.currentScript.src), !t)) {
                ...
                if (e.length)
                    for (var r = e.length - 1; r > -1 && (!t || !/^http(s?):/.test(t));) t = e[r--].src
            }
            if (!t) throw new Error("Automatic publicPath is not supported in this browser");
            t = t.replace(/#.*$/, "").replace(/\?.*$/, "").replace(/\/[^\/]+$/, "/"), c.p = t
        })(), (() => {
            var t = {
                792: 0
            };
            ...
            var n = (n, e) => {
                    ...
                    for (n && n(e); u < i.length; u++) o = i[u], c.o(t, o) && t[o] && t[o][0](), t[o] = 0
                },
                e = self.webpackChunkpwb_website_base = self.webpackChunkpwb_website_base || [];
            e.forEach(n.bind(null, 0)), e.push = n.bind(null, e.push.bind(e))
        })(), e = c(385), r = c(3664), o = c(4277),
        function() {
            const t = navigator.userAgent || navigator.vendor,
                n = (0, r.U1)(window.location.href, "/"),
                o = !!(0, e.A)(window, "TelegramWebview") || !!(0, e.A)(window, "TelegramWebviewProxy");
            if (["Instagram", "LinkedIn", "FBAN", "FBAV", "Slack", "Twitter"].some((n => t.includes(n))) || o) {
                const e = !!t.match(/iPhone|iPad|iPod/i);
                window.location.replace(e ? `x-safari-${n}` : `intent:${n}#Intent;end`)
            }
        }(), o.kr && Promise.all([c.e(658), c.e(191), c.e(875)]).then(c.bind(c, 5875)).then((t => {
            t.default()
        })), Promise.all([c.e(658), c.e(928), c.e(191), c.e(720)]).then(c.bind(c, 7720)).then((t => {
            t.default()
        }))
})();